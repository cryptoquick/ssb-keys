const expected = 'lFluepOmDxEUcZWlLfz0rHU61xLQYxknAEd6z4un8P8=.sha256'
const msg = {
...
test('test that the legacy code is as expected', t => {
  const actual = ssbKeys.hash(JSON.stringify(msg, null, 2))
